...
For prerequisites and detailed build instructions please read the [Installation Instructions](https://github.com/JFJun/bsc/wiki/Building-Ethereum) on the wiki.
...
[CLI Wiki page](https://github.com/JFJun/bsc/wiki/Command-Line-Options)).
...
and [`geth` specific APIs](https://github.com/JFJun/bsc/wiki/Management-APIs)).
